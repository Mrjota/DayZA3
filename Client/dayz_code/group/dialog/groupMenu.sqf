...
while{gActive} do
{
    ...
    if ((typeOf cursorTarget in ["SurvivorW2_DZ","Survivor2_DZ","Sniper1_DZ","Sniper2_DZ","Camo1_DZ","BanditW1_DZ","Bandit1_DZ","Bandit2_DZ","Survivor3_DZ","Survivor4_DZ","Survivor5_DZ","Bandit3_DZ","Survivor_R","Survivor_B","Ranger_DZ"]) and (player distance cursorTarget <= 5)) then {
